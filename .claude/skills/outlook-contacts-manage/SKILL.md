...
```bash
python3 scripts/graph_call.py POST "/me/contacts" '{
  "givenName": "Jane",
  "surname": "Doe",
...
```bash
python3 scripts/graph_call.py PATCH "/me/contacts/{contactId}" '{"jobTitle": "Senior Engineer", "companyName": "New Company"}'
```
