...
```bash
python3 scripts/graph_call.py GET "/me/mailFolders/inbox/messageRules"
```
...
```bash
python3 scripts/graph_call.py POST "/me/mailFolders/inbox/messageRules" '{"displayName":"RuleName","sequence":1,"isEnabled":true,"conditions":{},"actions":{}}'
```
...
```bash
python3 scripts/graph_call.py PATCH "/me/mailFolders/inbox/messageRules/{ruleId}" '{"sequence":2}'
```
