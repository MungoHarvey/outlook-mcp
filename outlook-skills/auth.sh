...
# Tokens:  outlook-skills/tokens.enc  (gitignored, never in Claude dirs)
# =============================================================================
...
ensure_config() {
    if [ ! -f "$CONFIG_FILE" ]; then
        ...
        echo ""
        echo "  Copy the template and fill in your Azure app details:"
        echo ""
        echo "    cp $CONFIG_EXAMPLE $CONFIG_FILE"
        echo "    # Edit $CONFIG_FILE — add tenant_id and client_id"
        echo ""
        exit 1
    fi
