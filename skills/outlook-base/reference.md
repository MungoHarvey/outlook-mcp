...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/scripts/graph_call.py GET "/me/calendar/calendarView?startDateTime=2025-03-20T00:00:00&endDateTime=2025-03-21T00:00:00" --header "Prefer: outlook.timezone=\"America/New_York\""
```
...
### Auto-Retry on 401
`python3 ${CLAUDE_PLUGIN_ROOT}/scripts/graph_call.py` handles 401 (Unauthorized) responses automatically:
