...
Optional (require admin consent on many managed tenants — omit unless you have it):
`Contacts.ReadWrite` (contacts-manage) and `MailboxSettings.ReadWrite` (rules, categories).
